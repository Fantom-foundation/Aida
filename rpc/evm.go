...
func newEvmExecutor(blockID uint64, archive state.NonCommittableStateDB, cfg *utils.Config, chainCfg *params.ChainConfig, params map[string]interface{}, timestamp uint64) *EvmExecutor {
	return &EvmExecutor{
