...
require (
	github.com/Fantom-foundation/Carmen/go v0.0.0-20240801115916-95f776fc98c8
...
replace github.com/Fantom-foundation/go-opera => github.com/Fantom-foundation/sonic v1.2.1-e.0.20240819094406-1f1745f8de78
