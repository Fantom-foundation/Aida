...
type Provider[T any] interface {
	// Run iterates through txcontext in the block range [from,to) in order
	// and forwards payload information for each txcontext in the range to
...
// TransactionInfo summarizes the per-txcontext information provided by a
// Provider.
