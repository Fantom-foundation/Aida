...
func (NilExtension) PreAction(executor.State, *executor.Context) error      { return nil }
func (NilExtension) PostAction(executor.State, *executor.Context) error     { return nil }
