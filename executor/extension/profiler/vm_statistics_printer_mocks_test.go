...
//
//	mockgen -source vm_statistics_printer_test.go -destination vm_statistics_printer_mocks_test.go -package profiler
//
...
func (mr *MockProfilingVmMockRecorder) NewInterpreter(evm, cfg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
