...
type Config struct {
	...
	UseGethBlockProcessor    bool           // if true, uses go-ethereum/core instead of go-opera/evmcore when ApplyMessage()
...
func (cc *configContext) reportNewConfig() {
	...
	log.Noticef("Forced geth block processor?: %v", cfg.UseGethBlockProcessor)
